...
//  while (!Serial); // Wait for serial connection
  ...
  senderTest = SimpleTransSender(&radio, matchOut[0], matchOut[1], 100);
...
/****************** Ping Out Role ***************************/  
  ...
  double send_time = (millis()%32768)/100.;                       // Take the time, and send it.  This will block until complete

  senderTest.sendFloat(send_time);
